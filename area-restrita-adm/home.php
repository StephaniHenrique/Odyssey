          ...
          <div class="col-xl-4 col-lg-12">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  ...
                  <p class="card-category">
                    <span class="text-success"><i class="fa fa-long-arrow-up"></i> 55% </span> de aumento nas vendas de hoje.</p>
                </div>
            ...
            <div class="col-xl-4 col-lg-12">
              <div class="card card-chart">
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">access_time</i> Atualizado a 2 dias atrás
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-4 col-lg-12">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">Tarefas completas</h4>
                  <p class="card-category">Desempenho da última campanha</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">access_time</i> Campanha realizada a 2 dias atrás
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <table class="table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>Vizualizar quantidade de acessos</td>
                            <td class="td-actions text-right">
                              <button type="button" rel="tooltip" title="Edit Task" class="btn btn-white btn-link btn-sm">
                                <i class="material-icons">edit</i>
                              </button>
                          ...
                          <tr>
                            ...
                            <td>Verificar produtos mais vendidos</td>
                            <td class="td-actions text-right">
                              <button type="button" rel="tooltip" title="Edit Task" class="btn btn-white btn-link btn-sm">
                                <i class="material-icons">edit</i>
                              </button>
                           ...
                           <tr>
                            ...
                            <td>Adicionar cupom de desconto
                            </td>
                            <td class="td-actions text-right">
                              <button type="button" rel="tooltip" title="Edit Task" class="btn btn-white btn-link btn-sm">
                                <i class="material-icons">edit</i>
                      ...
                      <table class="table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>Liberar novos produtos para os usuários
                            </td>
                            <td class="td-actions text-right">
                              <button type="button" rel="tooltip" title="Edit Task" class="btn btn-white btn-link btn-sm">
                                <i class="material-icons">edit</i>
                          ...
                          <tr>
                            ...
                            <td>Liberar prévia de 'The Last Of Us 2'</td>
                            <td class="td-actions text-right">
                              <button type="button" rel="tooltip" title="Edit Task" class="btn btn-white btn-link btn-sm">
                                <i class="material-icons">edit</i>
                              </button>
                      ...
                      <table class="table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>Manutenção do banco de dados</td>
                            <td class="td-actions text-right">
                              <button type="button" rel="tooltip" title="Edit Task" class="btn btn-white btn-link btn-sm">
                                <i class="material-icons">edit</i>
                              </button>
                            ...
                            <td>Backup de dados do Servidor de Administração</td>
                            <td class="td-actions text-right">
                              <button type="button" rel="tooltip" title="Edit Task" class="btn btn-white btn-link btn-sm">
                                <i class="material-icons">edit</i>
                              </button>
